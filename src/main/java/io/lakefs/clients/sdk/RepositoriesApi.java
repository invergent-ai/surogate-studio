...
import io.lakefs.clients.sdk.model.SqlQueryResults;
...
public class RepositoriesApi {
    ...
    private okhttp3.Call sqlQueryCall(String query, Integer amount, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/repositories/sql_query";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sqlQueryValidateBeforeCall(String query, Integer amount, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'query' is set
        if (query == null) {
            throw new ApiException("Missing the required parameter 'query' when calling sqlQuery(Async)");
        }

        return sqlQueryCall(query, amount, _callback);

    }


    private ApiResponse<SqlQueryResults> sqlQueryWithHttpInfo(String query, Integer amount) throws ApiException {
        okhttp3.Call localVarCall = sqlQueryValidateBeforeCall(query, amount, null);
        Type localVarReturnType = new TypeToken<SqlQueryResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call sqlQueryAsync(String query, Integer amount, final ApiCallback<SqlQueryResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = sqlQueryValidateBeforeCall(query, amount, _callback);
        Type localVarReturnType = new TypeToken<SqlQueryResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIsqlQueryRequest {
        private final String query;
        private Integer amount;

        private APIsqlQueryRequest(String query) {
            this.query = query;
        }
         ...
         * Set amount
         * @param amount how many items to return (optional, default to 100)
         * @return APIsqlQueryRequest
         */
        public APIsqlQueryRequest amount(Integer amount) {
            this.amount = amount;
            return this;
        }
         ...
         */
        public SqlQueryResults execute() throws ApiException {
            ApiResponse<SqlQueryResults> localVarResp = sqlQueryWithHttpInfo(query, amount);
            return localVarResp.getData();
        }

        /**
         * Execute sqlQuery request with HTTP info returned
         * @return ApiResponse&lt;SqlQueryResults&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<SqlQueryResults> executeWithHttpInfo() throws ApiException {
            return sqlQueryWithHttpInfo(query, amount);
        }

        /**
         * Execute sqlQuery request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<SqlQueryResults> _callback) throws ApiException {
            return sqlQueryAsync(query, amount, _callback);
        }
    }

    /**
     * Run a DuckDB query on an object
     * 
     ...
     */
    public APIsqlQueryRequest sqlQuery(String query) {
        return new APIsqlQueryRequest(query);
    }
}
