 ...
 */
@ApiModel(description = "MirrorService holds the mirror configuration.")
...
public class V1alpha1TraefikServiceSpecMirroringMirrors {
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors healthCheck(V1alpha1IngressRouteSpecHealthCheck healthCheck) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors kind(KindEnum kind) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors name(String name) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors nativeLB(Boolean nativeLB) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors nodePortLB(Boolean nodePortLB) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors passHostHeader(Boolean passHostHeader) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors percent(Integer percent) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Percent defines the part of the traffic to mirror. Supported values: 0 to 100.")
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors port(Object port) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors responseForwarding(V1alpha1IngressRouteSpecResponseForwarding responseForwarding) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors scheme(String scheme) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors serversTransport(String serversTransport) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors sticky(V1alpha1IngressRouteSpecSticky sticky) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors strategy(String strategy) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroringMirrors weight(Integer weight) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1TraefikServiceSpecMirroringMirrors v1alpha1TraefikServiceSpecMirroringMirrors = (V1alpha1TraefikServiceSpecMirroringMirrors) o;
    return Objects.equals(this.healthCheck, v1alpha1TraefikServiceSpecMirroringMirrors.healthCheck) &&
        Objects.equals(this.kind, v1alpha1TraefikServiceSpecMirroringMirrors.kind) &&
        Objects.equals(this.name, v1alpha1TraefikServiceSpecMirroringMirrors.name) &&
        Objects.equals(this.namespace, v1alpha1TraefikServiceSpecMirroringMirrors.namespace) &&
        Objects.equals(this.nativeLB, v1alpha1TraefikServiceSpecMirroringMirrors.nativeLB) &&
        Objects.equals(this.nodePortLB, v1alpha1TraefikServiceSpecMirroringMirrors.nodePortLB) &&
        Objects.equals(this.passHostHeader, v1alpha1TraefikServiceSpecMirroringMirrors.passHostHeader) &&
        Objects.equals(this.percent, v1alpha1TraefikServiceSpecMirroringMirrors.percent) &&
        Objects.equals(this.port, v1alpha1TraefikServiceSpecMirroringMirrors.port) &&
        Objects.equals(this.responseForwarding, v1alpha1TraefikServiceSpecMirroringMirrors.responseForwarding) &&
        Objects.equals(this.scheme, v1alpha1TraefikServiceSpecMirroringMirrors.scheme) &&
        Objects.equals(this.serversTransport, v1alpha1TraefikServiceSpecMirroringMirrors.serversTransport) &&
        Objects.equals(this.sticky, v1alpha1TraefikServiceSpecMirroringMirrors.sticky) &&
        Objects.equals(this.strategy, v1alpha1TraefikServiceSpecMirroringMirrors.strategy) &&
        Objects.equals(this.weight, v1alpha1TraefikServiceSpecMirroringMirrors.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(healthCheck, kind, name, namespace, nativeLB, nodePortLB, passHostHeader, percent, port, responseForwarding, scheme, serversTransport, sticky, strategy, weight);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1TraefikServiceSpecMirroringMirrors {\n");
