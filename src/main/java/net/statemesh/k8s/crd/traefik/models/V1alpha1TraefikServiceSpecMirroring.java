...
import net.statemesh.k8s.crd.traefik.models.V1alpha1TraefikServiceSpecMirroringMirrors;

/**
 * Mirroring defines the Mirroring service configuration.
 */
@ApiModel(description = "Mirroring defines the Mirroring service configuration.")
...
public class V1alpha1TraefikServiceSpecMirroring {
  ...
  public static final String SERIALIZED_NAME_MIRROR_BODY = "mirrorBody";
  @SerializedName(SERIALIZED_NAME_MIRROR_BODY)
  private Boolean mirrorBody;

  public static final String SERIALIZED_NAME_MIRRORS = "mirrors";
  @SerializedName(SERIALIZED_NAME_MIRRORS)
  private List<V1alpha1TraefikServiceSpecMirroringMirrors> mirrors = null;
  ...
  public V1alpha1TraefikServiceSpecMirroring healthCheck(V1alpha1IngressRouteSpecHealthCheck healthCheck) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring kind(KindEnum kind) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring maxBodySize(Long maxBodySize) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "MaxBodySize defines the maximum size allowed for the body of the request. If the body is larger, the request is not mirrored. Default value is -1, which means unlimited size.")
  ...
  public V1alpha1TraefikServiceSpecMirroring mirrorBody(Boolean mirrorBody) {
    
    this.mirrorBody = mirrorBody;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "MirrorBody defines whether the body of the request should be mirrored. Default value is true.")

  public Boolean getMirrorBody() {
    return mirrorBody;
  }


  public void setMirrorBody(Boolean mirrorBody) {
    this.mirrorBody = mirrorBody;
  }


  public V1alpha1TraefikServiceSpecMirroring mirrors(List<V1alpha1TraefikServiceSpecMirroringMirrors> mirrors) {
    
    this.mirrors = mirrors;
    return this;
  }

  public V1alpha1TraefikServiceSpecMirroring addMirrorsItem(V1alpha1TraefikServiceSpecMirroringMirrors mirrorsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Mirrors defines the list of mirrors where Traefik will duplicate the traffic.")

  public List<V1alpha1TraefikServiceSpecMirroringMirrors> getMirrors() {
    return mirrors;
  }


  public void setMirrors(List<V1alpha1TraefikServiceSpecMirroringMirrors> mirrors) {
    this.mirrors = mirrors;
  }


  public V1alpha1TraefikServiceSpecMirroring name(String name) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring nativeLB(Boolean nativeLB) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring nodePortLB(Boolean nodePortLB) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring passHostHeader(Boolean passHostHeader) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring port(Object port) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring responseForwarding(V1alpha1IngressRouteSpecResponseForwarding responseForwarding) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring scheme(String scheme) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring serversTransport(String serversTransport) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring sticky(V1alpha1IngressRouteSpecSticky sticky) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring strategy(String strategy) {
  ...
  **/
  ...
  public V1alpha1TraefikServiceSpecMirroring weight(Integer weight) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1TraefikServiceSpecMirroring v1alpha1TraefikServiceSpecMirroring = (V1alpha1TraefikServiceSpecMirroring) o;
    return Objects.equals(this.healthCheck, v1alpha1TraefikServiceSpecMirroring.healthCheck) &&
        Objects.equals(this.kind, v1alpha1TraefikServiceSpecMirroring.kind) &&
        Objects.equals(this.maxBodySize, v1alpha1TraefikServiceSpecMirroring.maxBodySize) &&
        Objects.equals(this.mirrorBody, v1alpha1TraefikServiceSpecMirroring.mirrorBody) &&
        Objects.equals(this.mirrors, v1alpha1TraefikServiceSpecMirroring.mirrors) &&
        Objects.equals(this.name, v1alpha1TraefikServiceSpecMirroring.name) &&
        Objects.equals(this.namespace, v1alpha1TraefikServiceSpecMirroring.namespace) &&
        Objects.equals(this.nativeLB, v1alpha1TraefikServiceSpecMirroring.nativeLB) &&
        Objects.equals(this.nodePortLB, v1alpha1TraefikServiceSpecMirroring.nodePortLB) &&
        Objects.equals(this.passHostHeader, v1alpha1TraefikServiceSpecMirroring.passHostHeader) &&
        Objects.equals(this.port, v1alpha1TraefikServiceSpecMirroring.port) &&
        Objects.equals(this.responseForwarding, v1alpha1TraefikServiceSpecMirroring.responseForwarding) &&
        Objects.equals(this.scheme, v1alpha1TraefikServiceSpecMirroring.scheme) &&
        Objects.equals(this.serversTransport, v1alpha1TraefikServiceSpecMirroring.serversTransport) &&
        Objects.equals(this.sticky, v1alpha1TraefikServiceSpecMirroring.sticky) &&
        Objects.equals(this.strategy, v1alpha1TraefikServiceSpecMirroring.strategy) &&
        Objects.equals(this.weight, v1alpha1TraefikServiceSpecMirroring.weight);
  }

  @Override
  public int hashCode() {
    return Objects.hash(healthCheck, kind, maxBodySize, mirrorBody, mirrors, name, namespace, nativeLB, nodePortLB, passHostHeader, port, responseForwarding, scheme, serversTransport, sticky, strategy, weight);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1TraefikServiceSpecMirroring {\n");
    sb.append("    healthCheck: ").append(toIndentedString(healthCheck)).append("\n");
    sb.append("    kind: ").append(toIndentedString(kind)).append("\n");
    sb.append("    maxBodySize: ").append(toIndentedString(maxBodySize)).append("\n");
    sb.append("    mirrorBody: ").append(toIndentedString(mirrorBody)).append("\n");
