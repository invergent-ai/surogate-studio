 ...
 */
@ApiModel(description = "Service defines the reference to a Kubernetes Service that will serve the error page. More info: https://doc.traefik.io/traefik/v3.3/middlewares/http/errorpages/#service")
...
public class V1alpha1MiddlewareSpecErrorsService {
  ...
  public V1alpha1MiddlewareSpecErrorsService healthCheck(V1alpha1IngressRouteSpecHealthCheck healthCheck) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService kind(KindEnum kind) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService name(String name) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService namespace(String namespace) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService nativeLB(Boolean nativeLB) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService nodePortLB(Boolean nodePortLB) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService passHostHeader(Boolean passHostHeader) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService port(Object port) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService responseForwarding(V1alpha1IngressRouteSpecResponseForwarding responseForwarding) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService scheme(String scheme) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService serversTransport(String serversTransport) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService sticky(V1alpha1IngressRouteSpecSticky sticky) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService strategy(String strategy) {
  ...
  **/
  ...
  public V1alpha1MiddlewareSpecErrorsService weight(Integer weight) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1MiddlewareSpecErrorsService v1alpha1MiddlewareSpecErrorsService = (V1alpha1MiddlewareSpecErrorsService) o;
    return Objects.equals(this.healthCheck, v1alpha1MiddlewareSpecErrorsService.healthCheck) &&
        Objects.equals(this.kind, v1alpha1MiddlewareSpecErrorsService.kind) &&
        Objects.equals(this.name, v1alpha1MiddlewareSpecErrorsService.name) &&
        Objects.equals(this.namespace, v1alpha1MiddlewareSpecErrorsService.namespace) &&
        Objects.equals(this.nativeLB, v1alpha1MiddlewareSpecErrorsService.nativeLB) &&
        Objects.equals(this.nodePortLB, v1alpha1MiddlewareSpecErrorsService.nodePortLB) &&
        Objects.equals(this.passHostHeader, v1alpha1MiddlewareSpecErrorsService.passHostHeader) &&
        Objects.equals(this.port, v1alpha1MiddlewareSpecErrorsService.port) &&
        Objects.equals(this.responseForwarding, v1alpha1MiddlewareSpecErrorsService.responseForwarding) &&
        Objects.equals(this.scheme, v1alpha1MiddlewareSpecErrorsService.scheme) &&
        Objects.equals(this.serversTransport, v1alpha1MiddlewareSpecErrorsService.serversTransport) &&
        Objects.equals(this.sticky, v1alpha1MiddlewareSpecErrorsService.sticky) &&
        Objects.equals(this.strategy, v1alpha1MiddlewareSpecErrorsService.strategy) &&
        Objects.equals(this.weight, v1alpha1MiddlewareSpecErrorsService.weight);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1MiddlewareSpecErrorsService {\n");
