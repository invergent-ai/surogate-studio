...
import net.statemesh.k8s.crd.rayjob.models.V1RayJobSpec;
import net.statemesh.k8s.crd.rayjob.models.V1RayJobStatus;
...
public class V1RayJob implements io.kubernetes.client.common.KubernetesObject {
  ...
  private V1RayJobSpec spec;

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private V1RayJobStatus status;

  public V1RayJob() {
  }

  public V1RayJob apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1RayJob metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1RayJob spec(V1RayJobSpec spec) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1RayJobSpec getSpec() {
    return spec;
  }


  public void setSpec(V1RayJobSpec spec) {
    this.spec = spec;
  }


  public V1RayJob status(V1RayJobStatus status) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1RayJobStatus getStatus() {
    return status;
  }


  public void setStatus(V1RayJobStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiVersion, v1RayJob.apiVersion) &&
        Objects.equals(this.kind, v1RayJob.kind) &&
        Objects.equals(this.metadata, v1RayJob.metadata) &&
        Objects.equals(this.spec, v1RayJob.spec) &&
        Objects.equals(this.status, v1RayJob.status);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        V1RayJobSpec.validateJsonObject(jsonObj.getAsJsonObject("spec"));
      }
      // validate the optional field `status`
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        V1RayJobStatus.validateJsonObject(jsonObj.getAsJsonObject("status"));
      }
  }
