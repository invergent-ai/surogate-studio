...
import net.statemesh.k8s.crd.tekton.models.V1TaskSpecSidecarsInnerLifecycle;
import net.statemesh.k8s.crd.tekton.models.V1TaskSpecSidecarsInnerLivenessProbe;
import net.statemesh.k8s.crd.tekton.models.V1TaskSpecSidecarsInnerPortsInner;
import net.statemesh.k8s.crd.tekton.models.V1TaskSpecSidecarsInnerReadinessProbe;
import net.statemesh.k8s.crd.tekton.models.V1TaskSpecSidecarsInnerSecurityContext;
import net.statemesh.k8s.crd.tekton.models.V1TaskSpecSidecarsInnerStartupProbe;
...
import net.statemesh.k8s.crd.tekton.models.V1beta1TaskSpecSidecarsInnerResources;
...
public class V1beta1TaskSpecSidecarsInner {
  ...
  private V1TaskSpecSidecarsInnerReadinessProbe readinessProbe;

  public static final String SERIALIZED_NAME_RESOURCES = "resources";
  @SerializedName(SERIALIZED_NAME_RESOURCES)
  private V1beta1TaskSpecSidecarsInnerResources resources;
  ...
  private V1TaskSpecSidecarsInnerSecurityContext securityContext;

  public static final String SERIALIZED_NAME_STARTUP_PROBE = "startupProbe";
  @SerializedName(SERIALIZED_NAME_STARTUP_PROBE)
  private V1TaskSpecSidecarsInnerStartupProbe startupProbe;
  ...
  public V1beta1TaskSpecSidecarsInner() {
  }

  public V1beta1TaskSpecSidecarsInner args(List<String> args) {
    
    this.args = args;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addArgsItem(String argsItem) {
    if (this.args == null) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner command(List<String> command) {
    
    this.command = command;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addCommandItem(String commandItem) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner env(List<V1PipelineRunSpecTaskRunSpecsInnerPodTemplateEnvInner> env) {
    
    this.env = env;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addEnvItem(V1PipelineRunSpecTaskRunSpecsInnerPodTemplateEnvInner envItem) {
    if (this.env == null) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner envFrom(List<V1TaskSpecSidecarsInnerEnvFromInner> envFrom) {
    
    this.envFrom = envFrom;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addEnvFromItem(V1TaskSpecSidecarsInnerEnvFromInner envFromItem) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner image(String image) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner imagePullPolicy(String imagePullPolicy) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner lifecycle(V1TaskSpecSidecarsInnerLifecycle lifecycle) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1TaskSpecSidecarsInnerLifecycle getLifecycle() {
    return lifecycle;
  }


  public void setLifecycle(V1TaskSpecSidecarsInnerLifecycle lifecycle) {
    this.lifecycle = lifecycle;
  }


  public V1beta1TaskSpecSidecarsInner livenessProbe(V1TaskSpecSidecarsInnerLivenessProbe livenessProbe) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1TaskSpecSidecarsInnerLivenessProbe getLivenessProbe() {
    return livenessProbe;
  }


  public void setLivenessProbe(V1TaskSpecSidecarsInnerLivenessProbe livenessProbe) {
    this.livenessProbe = livenessProbe;
  }


  public V1beta1TaskSpecSidecarsInner name(String name) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner ports(List<V1TaskSpecSidecarsInnerPortsInner> ports) {
    
    this.ports = ports;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addPortsItem(V1TaskSpecSidecarsInnerPortsInner portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner readinessProbe(V1TaskSpecSidecarsInnerReadinessProbe readinessProbe) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1TaskSpecSidecarsInnerReadinessProbe getReadinessProbe() {
    return readinessProbe;
  }


  public void setReadinessProbe(V1TaskSpecSidecarsInnerReadinessProbe readinessProbe) {
    this.readinessProbe = readinessProbe;
  }


  public V1beta1TaskSpecSidecarsInner resources(V1beta1TaskSpecSidecarsInnerResources resources) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1beta1TaskSpecSidecarsInnerResources getResources() {
    return resources;
  }


  public void setResources(V1beta1TaskSpecSidecarsInnerResources resources) {
    this.resources = resources;
  }


  public V1beta1TaskSpecSidecarsInner restartPolicy(String restartPolicy) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner script(String script) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner securityContext(V1TaskSpecSidecarsInnerSecurityContext securityContext) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1TaskSpecSidecarsInnerSecurityContext getSecurityContext() {
    return securityContext;
  }


  public void setSecurityContext(V1TaskSpecSidecarsInnerSecurityContext securityContext) {
    this.securityContext = securityContext;
  }


  public V1beta1TaskSpecSidecarsInner startupProbe(V1TaskSpecSidecarsInnerStartupProbe startupProbe) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1TaskSpecSidecarsInnerStartupProbe getStartupProbe() {
    return startupProbe;
  }


  public void setStartupProbe(V1TaskSpecSidecarsInnerStartupProbe startupProbe) {
    this.startupProbe = startupProbe;
  }


  public V1beta1TaskSpecSidecarsInner stdin(Boolean stdin) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner stdinOnce(Boolean stdinOnce) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner terminationMessagePath(String terminationMessagePath) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner terminationMessagePolicy(String terminationMessagePolicy) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner tty(Boolean tty) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner volumeDevices(List<V1TaskSpecSidecarsInnerVolumeDevicesInner> volumeDevices) {
    
    this.volumeDevices = volumeDevices;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addVolumeDevicesItem(V1TaskSpecSidecarsInnerVolumeDevicesInner volumeDevicesItem) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner volumeMounts(List<V1TaskSpecSidecarsInnerVolumeMountsInner> volumeMounts) {
    
    this.volumeMounts = volumeMounts;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addVolumeMountsItem(V1TaskSpecSidecarsInnerVolumeMountsInner volumeMountsItem) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner workingDir(String workingDir) {
  ...
  **/
  ...
  public V1beta1TaskSpecSidecarsInner workspaces(List<V1TaskSpecSidecarsInnerWorkspacesInner> workspaces) {
    
    this.workspaces = workspaces;
    return this;
  }

  public V1beta1TaskSpecSidecarsInner addWorkspacesItem(V1TaskSpecSidecarsInnerWorkspacesInner workspacesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1beta1TaskSpecSidecarsInner v1beta1TaskSpecSidecarsInner = (V1beta1TaskSpecSidecarsInner) o;
    return Objects.equals(this.args, v1beta1TaskSpecSidecarsInner.args) &&
        Objects.equals(this.command, v1beta1TaskSpecSidecarsInner.command) &&
        Objects.equals(this.env, v1beta1TaskSpecSidecarsInner.env) &&
        Objects.equals(this.envFrom, v1beta1TaskSpecSidecarsInner.envFrom) &&
        Objects.equals(this.image, v1beta1TaskSpecSidecarsInner.image) &&
        Objects.equals(this.imagePullPolicy, v1beta1TaskSpecSidecarsInner.imagePullPolicy) &&
        Objects.equals(this.lifecycle, v1beta1TaskSpecSidecarsInner.lifecycle) &&
        Objects.equals(this.livenessProbe, v1beta1TaskSpecSidecarsInner.livenessProbe) &&
        Objects.equals(this.name, v1beta1TaskSpecSidecarsInner.name) &&
        Objects.equals(this.ports, v1beta1TaskSpecSidecarsInner.ports) &&
        Objects.equals(this.readinessProbe, v1beta1TaskSpecSidecarsInner.readinessProbe) &&
        Objects.equals(this.resources, v1beta1TaskSpecSidecarsInner.resources) &&
        Objects.equals(this.restartPolicy, v1beta1TaskSpecSidecarsInner.restartPolicy) &&
        Objects.equals(this.script, v1beta1TaskSpecSidecarsInner.script) &&
        Objects.equals(this.securityContext, v1beta1TaskSpecSidecarsInner.securityContext) &&
        Objects.equals(this.startupProbe, v1beta1TaskSpecSidecarsInner.startupProbe) &&
        Objects.equals(this.stdin, v1beta1TaskSpecSidecarsInner.stdin) &&
        Objects.equals(this.stdinOnce, v1beta1TaskSpecSidecarsInner.stdinOnce) &&
        Objects.equals(this.terminationMessagePath, v1beta1TaskSpecSidecarsInner.terminationMessagePath) &&
        Objects.equals(this.terminationMessagePolicy, v1beta1TaskSpecSidecarsInner.terminationMessagePolicy) &&
        Objects.equals(this.tty, v1beta1TaskSpecSidecarsInner.tty) &&
        Objects.equals(this.volumeDevices, v1beta1TaskSpecSidecarsInner.volumeDevices) &&
        Objects.equals(this.volumeMounts, v1beta1TaskSpecSidecarsInner.volumeMounts) &&
        Objects.equals(this.workingDir, v1beta1TaskSpecSidecarsInner.workingDir) &&
        Objects.equals(this.workspaces, v1beta1TaskSpecSidecarsInner.workspaces);
  }

  @Override
  public int hashCode() {
    return Objects.hash(args, command, env, envFrom, image, imagePullPolicy, lifecycle, livenessProbe, name, ports, readinessProbe, resources, restartPolicy, script, securityContext, startupProbe, stdin, stdinOnce, terminationMessagePath, terminationMessagePolicy, tty, volumeDevices, volumeMounts, workingDir, workspaces);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class V1beta1TaskSpecSidecarsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1beta1TaskSpecSidecarsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1beta1TaskSpecSidecarsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1beta1TaskSpecSidecarsInner is not found in the empty JSON string", V1beta1TaskSpecSidecarsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1beta1TaskSpecSidecarsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1beta1TaskSpecSidecarsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1beta1TaskSpecSidecarsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("lifecycle") != null && !jsonObj.get("lifecycle").isJsonNull()) {
        V1TaskSpecSidecarsInnerLifecycle.validateJsonObject(jsonObj.getAsJsonObject("lifecycle"));
      }
      // validate the optional field `livenessProbe`
      if (jsonObj.get("livenessProbe") != null && !jsonObj.get("livenessProbe").isJsonNull()) {
        V1TaskSpecSidecarsInnerLivenessProbe.validateJsonObject(jsonObj.getAsJsonObject("livenessProbe"));
      }
      ...
      if (jsonObj.get("readinessProbe") != null && !jsonObj.get("readinessProbe").isJsonNull()) {
        V1TaskSpecSidecarsInnerReadinessProbe.validateJsonObject(jsonObj.getAsJsonObject("readinessProbe"));
      }
      // validate the optional field `resources`
      if (jsonObj.get("resources") != null && !jsonObj.get("resources").isJsonNull()) {
        V1beta1TaskSpecSidecarsInnerResources.validateJsonObject(jsonObj.getAsJsonObject("resources"));
      }
      ...
      if (jsonObj.get("securityContext") != null && !jsonObj.get("securityContext").isJsonNull()) {
        V1TaskSpecSidecarsInnerSecurityContext.validateJsonObject(jsonObj.getAsJsonObject("securityContext"));
      }
      // validate the optional field `startupProbe`
      if (jsonObj.get("startupProbe") != null && !jsonObj.get("startupProbe").isJsonNull()) {
        V1TaskSpecSidecarsInnerStartupProbe.validateJsonObject(jsonObj.getAsJsonObject("startupProbe"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1beta1TaskSpecSidecarsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1beta1TaskSpecSidecarsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1beta1TaskSpecSidecarsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1beta1TaskSpecSidecarsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<V1beta1TaskSpecSidecarsInner>() {
           @Override
           public void write(JsonWriter out, V1beta1TaskSpecSidecarsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1beta1TaskSpecSidecarsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1beta1TaskSpecSidecarsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1beta1TaskSpecSidecarsInner
  * @throws IOException if the JSON string is invalid with respect to V1beta1TaskSpecSidecarsInner
  */
  public static V1beta1TaskSpecSidecarsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1beta1TaskSpecSidecarsInner.class);
  }

 /**
  * Convert an instance of V1beta1TaskSpecSidecarsInner to an JSON string
  *
  * @return JSON string
  */
