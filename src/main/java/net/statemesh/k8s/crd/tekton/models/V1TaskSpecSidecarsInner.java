...
import net.statemesh.k8s.crd.tekton.models.V1TaskSpecSidecarsInnerComputeResources;
...
public class V1TaskSpecSidecarsInner {
  ...
  private V1TaskSpecSidecarsInnerComputeResources computeResources;
  ...
  public V1TaskSpecSidecarsInner() {
  }

  public V1TaskSpecSidecarsInner args(List<String> args) {
    
    this.args = args;
    return this;
  }

  public V1TaskSpecSidecarsInner addArgsItem(String argsItem) {
    if (this.args == null) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner command(List<String> command) {
    
    this.command = command;
    return this;
  }

  public V1TaskSpecSidecarsInner addCommandItem(String commandItem) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner computeResources(V1TaskSpecSidecarsInnerComputeResources computeResources) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1TaskSpecSidecarsInnerComputeResources getComputeResources() {
    return computeResources;
  }


  public void setComputeResources(V1TaskSpecSidecarsInnerComputeResources computeResources) {
    this.computeResources = computeResources;
  }


  public V1TaskSpecSidecarsInner env(List<V1PipelineRunSpecTaskRunSpecsInnerPodTemplateEnvInner> env) {
    
    this.env = env;
    return this;
  }

  public V1TaskSpecSidecarsInner addEnvItem(V1PipelineRunSpecTaskRunSpecsInnerPodTemplateEnvInner envItem) {
    if (this.env == null) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner envFrom(List<V1TaskSpecSidecarsInnerEnvFromInner> envFrom) {
    
    this.envFrom = envFrom;
    return this;
  }

  public V1TaskSpecSidecarsInner addEnvFromItem(V1TaskSpecSidecarsInnerEnvFromInner envFromItem) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner image(String image) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner imagePullPolicy(String imagePullPolicy) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner lifecycle(V1TaskSpecSidecarsInnerLifecycle lifecycle) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner livenessProbe(V1TaskSpecSidecarsInnerLivenessProbe livenessProbe) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner name(String name) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner ports(List<V1TaskSpecSidecarsInnerPortsInner> ports) {
    
    this.ports = ports;
    return this;
  }

  public V1TaskSpecSidecarsInner addPortsItem(V1TaskSpecSidecarsInnerPortsInner portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner readinessProbe(V1TaskSpecSidecarsInnerReadinessProbe readinessProbe) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner restartPolicy(String restartPolicy) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner script(String script) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner securityContext(V1TaskSpecSidecarsInnerSecurityContext securityContext) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner startupProbe(V1TaskSpecSidecarsInnerStartupProbe startupProbe) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner stdin(Boolean stdin) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner stdinOnce(Boolean stdinOnce) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner terminationMessagePath(String terminationMessagePath) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner terminationMessagePolicy(String terminationMessagePolicy) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner tty(Boolean tty) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner volumeDevices(List<V1TaskSpecSidecarsInnerVolumeDevicesInner> volumeDevices) {
    
    this.volumeDevices = volumeDevices;
    return this;
  }

  public V1TaskSpecSidecarsInner addVolumeDevicesItem(V1TaskSpecSidecarsInnerVolumeDevicesInner volumeDevicesItem) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner volumeMounts(List<V1TaskSpecSidecarsInnerVolumeMountsInner> volumeMounts) {
    
    this.volumeMounts = volumeMounts;
    return this;
  }

  public V1TaskSpecSidecarsInner addVolumeMountsItem(V1TaskSpecSidecarsInnerVolumeMountsInner volumeMountsItem) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner workingDir(String workingDir) {
  ...
  **/
  ...
  public V1TaskSpecSidecarsInner workspaces(List<V1TaskSpecSidecarsInnerWorkspacesInner> workspaces) {
    
    this.workspaces = workspaces;
    return this;
  }

  public V1TaskSpecSidecarsInner addWorkspacesItem(V1TaskSpecSidecarsInnerWorkspacesInner workspacesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1TaskSpecSidecarsInner v1TaskSpecSidecarsInner = (V1TaskSpecSidecarsInner) o;
    return Objects.equals(this.args, v1TaskSpecSidecarsInner.args) &&
        Objects.equals(this.command, v1TaskSpecSidecarsInner.command) &&
        Objects.equals(this.computeResources, v1TaskSpecSidecarsInner.computeResources) &&
        Objects.equals(this.env, v1TaskSpecSidecarsInner.env) &&
        Objects.equals(this.envFrom, v1TaskSpecSidecarsInner.envFrom) &&
        Objects.equals(this.image, v1TaskSpecSidecarsInner.image) &&
        Objects.equals(this.imagePullPolicy, v1TaskSpecSidecarsInner.imagePullPolicy) &&
        Objects.equals(this.lifecycle, v1TaskSpecSidecarsInner.lifecycle) &&
        Objects.equals(this.livenessProbe, v1TaskSpecSidecarsInner.livenessProbe) &&
        Objects.equals(this.name, v1TaskSpecSidecarsInner.name) &&
        Objects.equals(this.ports, v1TaskSpecSidecarsInner.ports) &&
        Objects.equals(this.readinessProbe, v1TaskSpecSidecarsInner.readinessProbe) &&
        Objects.equals(this.restartPolicy, v1TaskSpecSidecarsInner.restartPolicy) &&
        Objects.equals(this.script, v1TaskSpecSidecarsInner.script) &&
        Objects.equals(this.securityContext, v1TaskSpecSidecarsInner.securityContext) &&
        Objects.equals(this.startupProbe, v1TaskSpecSidecarsInner.startupProbe) &&
        Objects.equals(this.stdin, v1TaskSpecSidecarsInner.stdin) &&
        Objects.equals(this.stdinOnce, v1TaskSpecSidecarsInner.stdinOnce) &&
        Objects.equals(this.terminationMessagePath, v1TaskSpecSidecarsInner.terminationMessagePath) &&
        Objects.equals(this.terminationMessagePolicy, v1TaskSpecSidecarsInner.terminationMessagePolicy) &&
        Objects.equals(this.tty, v1TaskSpecSidecarsInner.tty) &&
        Objects.equals(this.volumeDevices, v1TaskSpecSidecarsInner.volumeDevices) &&
        Objects.equals(this.volumeMounts, v1TaskSpecSidecarsInner.volumeMounts) &&
        Objects.equals(this.workingDir, v1TaskSpecSidecarsInner.workingDir) &&
        Objects.equals(this.workspaces, v1TaskSpecSidecarsInner.workspaces);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1TaskSpecSidecarsInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to V1TaskSpecSidecarsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!V1TaskSpecSidecarsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in V1TaskSpecSidecarsInner is not found in the empty JSON string", V1TaskSpecSidecarsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!V1TaskSpecSidecarsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `V1TaskSpecSidecarsInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : V1TaskSpecSidecarsInner.openapiRequiredFields) {
      ...
      if (jsonObj.get("computeResources") != null && !jsonObj.get("computeResources").isJsonNull()) {
        V1TaskSpecSidecarsInnerComputeResources.validateJsonObject(jsonObj.getAsJsonObject("computeResources"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!V1TaskSpecSidecarsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'V1TaskSpecSidecarsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<V1TaskSpecSidecarsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(V1TaskSpecSidecarsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<V1TaskSpecSidecarsInner>() {
           @Override
           public void write(JsonWriter out, V1TaskSpecSidecarsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public V1TaskSpecSidecarsInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of V1TaskSpecSidecarsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of V1TaskSpecSidecarsInner
  * @throws IOException if the JSON string is invalid with respect to V1TaskSpecSidecarsInner
  */
  public static V1TaskSpecSidecarsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, V1TaskSpecSidecarsInner.class);
  }

 /**
  * Convert an instance of V1TaskSpecSidecarsInner to an JSON string
  *
  * @return JSON string
  */
