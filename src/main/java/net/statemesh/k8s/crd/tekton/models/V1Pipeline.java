...
import net.statemesh.k8s.crd.tekton.models.V1PipelineSpec;
...
public class V1Pipeline implements io.kubernetes.client.common.KubernetesObject {
  ...
  public V1Pipeline apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1Pipeline kind(String kind) {
  ...
  **/
  ...
  public V1Pipeline metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1Pipeline spec(V1PipelineSpec spec) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiVersion, v1Pipeline.apiVersion) &&
        Objects.equals(this.kind, v1Pipeline.kind) &&
        Objects.equals(this.metadata, v1Pipeline.metadata) &&
        Objects.equals(this.spec, v1Pipeline.spec);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        V1PipelineSpec.validateJsonObject(jsonObj.getAsJsonObject("spec"));
      }
  }
