...
import net.statemesh.k8s.crd.raycluster.models.V1RayClusterSpec;
import net.statemesh.k8s.crd.raycluster.models.V1RayClusterStatus;
...
public class V1RayCluster implements io.kubernetes.client.common.KubernetesObject {
  ...
  private V1RayClusterSpec spec;

  public static final String SERIALIZED_NAME_STATUS = "status";
  @SerializedName(SERIALIZED_NAME_STATUS)
  private V1RayClusterStatus status;

  public V1RayCluster() {
  }

  public V1RayCluster apiVersion(String apiVersion) {
  ...
  **/
  ...
  public V1RayCluster metadata(V1ObjectMeta metadata) {
  ...
  **/
  ...
  public V1RayCluster spec(V1RayClusterSpec spec) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1RayClusterSpec getSpec() {
    return spec;
  }


  public void setSpec(V1RayClusterSpec spec) {
    this.spec = spec;
  }


  public V1RayCluster status(V1RayClusterStatus status) {
  ...
  **/
  @jakarta.annotation.Nullable
  public V1RayClusterStatus getStatus() {
    return status;
  }


  public void setStatus(V1RayClusterStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiVersion, v1RayCluster.apiVersion) &&
        Objects.equals(this.kind, v1RayCluster.kind) &&
        Objects.equals(this.metadata, v1RayCluster.metadata) &&
        Objects.equals(this.spec, v1RayCluster.spec) &&
        Objects.equals(this.status, v1RayCluster.status);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        V1RayClusterSpec.validateJsonObject(jsonObj.getAsJsonObject("spec"));
      }
      // validate the optional field `status`
      if (jsonObj.get("status") != null && !jsonObj.get("status").isJsonNull()) {
        V1RayClusterStatus.validateJsonObject(jsonObj.getAsJsonObject("status"));
      }
  }
