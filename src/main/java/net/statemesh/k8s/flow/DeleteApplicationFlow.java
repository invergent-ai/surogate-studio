...
@Component("deleteApplicationFlow")
@Slf4j
public class DeleteApplicationFlow extends BaseApplicationFlow {
    public DeleteApplicationFlow(KubernetesController kubernetesController,
